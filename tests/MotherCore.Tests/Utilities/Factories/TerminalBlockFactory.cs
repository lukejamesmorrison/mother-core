...
namespace MotherCore.Tests.Utilities.Factories
{
    ...
    public static class TerminalBlockFactory
    {
            ...
            where TBlock : class, IMyTerminalBlock
        {
            ...
            if (typeof(TBlock) == typeof(IMySearchlight))
                return new FakeSearchlight(customName: customName, customData: customData, entityId: entityId, cubeGrid: grid) as TBlock;
